"""
MegaCommerce Local Search Core — Custom Tokenizer & Text Normalizer
...
def tokenize(text: str, remove_stopwords: bool = True) -> List[str]:
    """Tokenizes string into normalized lowercase word tokens."""
    if not text:
        return []
...
def generate_ngrams(tokens: List[str], n: int = 2) -> List[str]:
    """Generates n-gram token combinations."""
    if len(tokens) < n:
        return []
